---
title: "PollVibes"
description: "A modern realtime polling platform for creating, sharing, and analyzing interactive polls with live analytics, secure authentication, and an intuitive dashboard."
date: "2026-07-13"
cover: "/studio/Projects/pollvibes-thumb.png"
livePreview: https://pollvibes.sulochanmahajan.com/
githubLink: https://github.com/Sulochan36/PulseBoard
techstack:
    - React
    - TypeScript
    - Node.js
...
![PollVibes Banner](/studio/Projects/Pollvibes.png)
...
<a href="https://pollvibes.sulochanmahajan.com/" className='font-bold underline hover:text-blue-400' target="_blank" rel="noopener noreferrer">
    Pollvibes - Go to website
</a>
