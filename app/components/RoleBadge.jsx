...
const RoleBadge = () => {
    ...
    return (
        <>
            <span className='border-[2px] border-neutral-400 inline-block px-2 py-0.5 w-fit items-center justify-center rounded-2xl bg-transparent transition duration-200'>
