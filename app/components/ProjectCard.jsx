...
const ProjectCard = ({ data }) => {
    ...
    return (
        <div className="relative max-w-sm h-[340px] rounded-lg bg-transparent flex flex-col gap-5 group hover:shadow-[0_3px_10px_rgb(21,93,252,0.3)] transition-all duration-500 overflow-hidden">
            ...
            <div className='transition-transform duration-300 group-hover:scale-y-[1.05]'>
                <a href="#">
                    ...
                    <div className='m-1.5 transform-[translateY(calc(100% + 6px + 1px))] transition-transform duration-500 ease-[cubic-breezer(0.19, 1, 0.22, 1)]'>
                        <a href="#">
