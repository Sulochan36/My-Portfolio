    ...
    return (
        ...
        <div className="group relative max-w-sm h-[340px] overflow-hidden rounded-2xl transition-all duration-500 border-2 border-neutral-700 shadow-[0_8px_30px_rgb(0,0,0,0.1)] dark:shadow-[0_5px_10px_rgb(255,255,255,0.1)]">
            ...
            <div className="group relative mx-auto h-[340px] w-[340px] overflow-hidden bg-white shadow-[0px_0px_0px_1px_rgba(9,9,11,0.08),0px_1px_2px_-1px_rgba(9,9,11,0.5),0px_2px_4px_0px_rgba(9,9,11,0.5)]">
                ...
                {/* sliding glass panel */}
                <div
                    className="absolute bottom-18 w-full border-t border-neutral-700 bg-[url('/noise.png')] bg-[size:220px] bg-repeat bg-white/10 backdrop-blur-3xl px-[14px] pt-[10px] pb-[13px] text-[13px] shadow-[0px_0px_0px_1px_rgba(0,0,0,0.08),0px_1px_2px_-1px_rgba(0,0,0,0.08),0px_2px_4px_0px_rgba(0,0,0,0.04)] translate-y-[calc(100%+7px)] transition-transform duration-[500ms] ease-[cubic-bezier(0.19,1,0.22,1)]
