...
const Blogs = async() => {
    ...
    return (
        <section id="projects" className='w-full flex flex-col justify-center items-center md:px-20 md:py-8 px-10 py-4 shadow-[inset_0_-4px_3px_0_rgba(0,0,0,0.1)] dark:shadow-[inset_0_-4px_3px_0_rgb(255,255,255,0.1)]'>
                    <h2 className='headings'>Blogs</h2>
            ...
            <Link href='/studio/blogs' className='rounded text-text text-sm px-2 py-2 mt-2 font-semibold bg-primary/20 hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.4)] duration-300 hover:bg-primary/80 text-center flex justify-center items-center'>View More Blogs</Link>
                </section>
    )
}
